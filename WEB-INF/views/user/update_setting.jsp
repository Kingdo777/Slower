...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<c:url value="/static/user/update_setting.css"/>">
    <script type="text/javascript" rel="script" src="<c:url value="/static/plugins/jquery-3.2.1.min.js"/>"></script>
    <script type="text/javascript" rel="script" src="<c:url value="/static/plugins/template.js"/>"></script>
    <script type="text/javascript" rel="script" src="<c:url value="/static/user/update_setting.js"/>"></script>
</head>
<header>
...
<div class="page">
    <textarea title="" id="input"></textarea>
</div>
